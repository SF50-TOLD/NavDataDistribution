...
struct ProcedureNameResolverTests {
  ...
  func namesILS() {
    #expect(
      resolver.approachName(icao: "KSFO", approachType: .ils, identifier: "I28L")
        == "ILS OR LOC RWY 28L"
    )
  }
  ...
  func namesLocalizer() {
    #expect(
      resolver.approachName(icao: "KSFO", approachType: .localizerOnly, identifier: "L28L")
        == "ILS OR LOC RWY 28L"
    )
  }
  ...
  func distinguishesRNAVFromRNP() {
    #expect(
      resolver.approachName(icao: "KSFO", approachType: .rnav, identifier: "R28RZ")
        == "RNAV (GPS) Z RWY 28R"
    )
    #expect(
      resolver.approachName(icao: "KSFO", approachType: .rnpAR, identifier: "H28RY")
        == "RNAV (RNP) Y RWY 28R"
    )
  }
  ...
  func missesUnchartedAirport() {
    #expect(
      resolver.approachName(icao: "EGLL", approachType: .ils, identifier: "I27R") == nil
    )
  }
